	...
	public DriverLicenseOcrVo driverLicenseOcr(MultipartFile file) {
		try {
			...
			if (StringUtils.hasText(resp.getName())) {
				...
				driverLicenseOcrVo=DriverLicenseOcrVo.builder()
						.name(resp.getName())
						.driverLicenseClazz(resp.getClass_())
						.driverLicenseNo(resp.getCardCode())
						.driverLicenseIssueDate(DateTimeFormat.forPattern("yyyy-MM-dd").parseDateTime(resp.getDateOfFirstIssue()).toDate())
						.driverLicenseExpire(DateTimeFormat.forPattern("yyyy-MM-dd").parseDateTime(resp.getEndDate()).toDate())
						.driverLicenseFrontUrl(cosUploadVo.getUrl())
						.driverLicenseFrontShowUrl(cosUploadVo.getShowUrl())
						.build();
			}else {
				CosUploadVo cosUploadVo =  cosService.upLoad(file, "driverLicense");
